## XX.XX.XX
* New Remote Config features added and accesible through "Countly.Instance.RemoteConfig()" interface:
  * "DownloadKeys"
  * "GetValues"
  * "GetValue"
* Added configuration function "EnableRemoteConfigAutomaticTriggers" to automatically download remote config values:
